...
--a ticket must be scanned twice		
fact ticketToUserantoShop{			
	all ticket:Ticket | #(ticket.scanned)<3
}
...
fact oneTotemOneShop{			
	no totem:Totem, shop1, shop2:Shop | totem in shop1.shopTotems and totem in shop2.shopTotems		
}			

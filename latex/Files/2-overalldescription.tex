...
What follows is  a short overview of the application workflow: from the real world to the machine computations.
We decided to give space to this descrption because we considered of relevant importance for the reader to embrace a more general idea of CLup before getting in the further details of the application scopes.
In this section we'll take the reader by the hand and walk them through the conceptual developement of CLUP, from what we starting with, so the data recollected, to the main concept in which we summarize those data -the concept of ticket- and finally to how we organize those data -a queue of tickets through time-. We take advantage of this overview also to specify some mechanism through which our application will work.


\begin{itemize}[topsep=0pt]
    \item \textbf{Reach clients, collect data from the people that interact with the system, making estimations}\\
    ...
    In any case, the main source of data we are provided with are the ones feeded into the system by the users that books visists and enqueue themselves.
    ...
    These data will be useful to make correct estimations about the status of the shop, and, thus, for the user-experience sake. The more we have reliable and early information about users' movements, the more our estimations will be precise and the general user-experience pleasant.

...
\begin{table}[h!]
    ...
    \begin{tabular}{@{}P{0.1\textwidth}P{0.80\textwidth}@{}}
        ...
        \textbf{G7}        & Allow a customer to join the virtual queue from the app\\
        \textbf{G8}        & Allow a user to sign on the system\\
        \textbf{G9}        & Allow a registered-user to sign in the system\\
        \textbf{G10}       & Allow a registered-user to book a shopping session at a grocery store\\
        $\;\;$    G10.1 & Allow a registered-user to select the time and duration(between predefined options) for they session\\ 	
        $\;\;$    G10.2 & Allow a registered-user to select categories of items they are willing to buy\\
        \textbf{G11}       & Allow a registered-user to check retrieve informations about its previously booked visits\\
...
\begin{table}[h!]
    ...
    \begin{tabular}{@{}P{0.1\textwidth}P{0.80\textwidth}@{}}
        ...
        \textbf{D5}        & The number of person entering the store is coherent with the data related to the QR code scanned\\
        ...
        \textbf{D8}       & A customer will take the shortest path to the store when they receive the notification (anche questo non mi sembra proprio una domain assumption, però la lascerei)\\
        ...
        \textbf{D13}       & people are not malicious against the app (well, problem solved. lol... )\\
        \bottomrule
    \end{tabular}

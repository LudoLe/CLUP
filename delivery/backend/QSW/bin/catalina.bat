...
set CATALINA_HOME=%CURRENT_DIR%
set CATALINA_TMPDIR=%CURRENT_DIR%\temp
set CLASSPATH=%CURRENT_DIR%\bin\bootstrap.jar;C:\Program Files\apache-tomee-plume-8.0.6\bin\tomcat-juli.jar

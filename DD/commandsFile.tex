...
% for java lstlistings:
\usepackage{xcolor}
\definecolor{pblue}{rgb}{0.13,0.13,1}
\definecolor{pgreen}{rgb}{0,0.5,0}
\definecolor{darkpurple}{RGB}{147, 3, 166}
\definecolor{darkorange}{RGB}{227, 106, 0}
...
\lstdefinestyle{mystyle}
{
    ...
    numberstyle=\tiny,
    commentstyle = \color{darkorange}, %% set comment color
    keywordstyle = \color{pblue}, %% set keyword color
    stringstyle = \color{pgreen}, %% set string color
    basicstyle = \scriptsize \ttfamily , %% set listing font and size
    breaklines = true, %% enable line breaking
    keywordstyle = [2]{\color{darkpurple}},
    morekeywords = [2]{Integer, ArrayList, TimeSlot, Queue, Ticket, TicketType},
}

%short form for java inputs
\newcommand{\javaFile}[1]{
  \lstinputlisting[style=mystyle, escapeinside={(*@}{@*)}]{#1}
}

%Define new header and footer style
\usepackage{fancyhdr}

\definecolor{ClupColor}{HTML}{54E2F0} % TODO: oppure sostituisci con 'Gray'
...
keepaspectratio]{Images/Titlepage.png}%
\vfill
}}}